...
public class SaltpackEncryptOptions {
  ...
  public class func fromJSON(_ json: JSON) -> SaltpackEncryptOptions {
  ...
  public class func fromJSONArray(_ json: [JSON]) -> [SaltpackEncryptOptions] {
...
public class SaltpackDecryptOptions {
  ...
  public class func fromJSON(_ json: JSON) -> SaltpackDecryptOptions {
  ...
  public class func fromJSONArray(_ json: [JSON]) -> [SaltpackDecryptOptions] {
    return json.map { fromJSON($0) }
  }
...
public class SaltpackSignOptions {
  ...
  public class func fromJSON(_ json: JSON) -> SaltpackSignOptions {
    return SaltpackSignOptions(detached: json["detached"].boolValue, binary: json["binary"].boolValue)
  }

  public class func fromJSONArray(_ json: [JSON]) -> [SaltpackSignOptions] {
    return json.map { fromJSON($0) }
  }
...
public class SaltpackVerifyOptions {
  ...
  public class func fromJSON(_ json: JSON) -> SaltpackVerifyOptions {
    return SaltpackVerifyOptions(signedBy: json["signedBy"].stringValue, signature: json["signature"].object as! NSData)
  }

  public class func fromJSONArray(_ json: [JSON]) -> [SaltpackVerifyOptions] {
    return json.map { fromJSON($0) }
  }
...
public class SaltpackEncryptedMessageInfo {
	...
	public let sender: SaltpackSender?

  public init(devices: [Device], numAnonReceivers: Int, receiverIsAnon: Bool, sender: SaltpackSender) {
  ...
  public class func fromJSON(_ json: JSON) -> SaltpackEncryptedMessageInfo {
    return SaltpackEncryptedMessageInfo(devices: Device.fromJSONArray(json["devices"].arrayValue), numAnonReceivers: json["numAnonReceivers"].intValue, receiverIsAnon: json["receiverIsAnon"].boolValue, sender: SaltpackSender.fromJSON(json["sender"]))
  }

  public class func fromJSONArray(_ json: [JSON]) -> [SaltpackEncryptedMessageInfo] {
    return json.map { fromJSON($0) }
  }
